...
void SimpleEQAudioProcessor::updatePeakSettings(const ChainSettings &chainSettings)
{
...
void SimpleEQAudioProcessor::updateFilters()
{
    ...
    updatePeakSettings(chainSettings);
}
    ...
    SimpleEQAudioProcessor::createParameterLayout()
{
        ...
        layout.add(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID{"Peak Quality", 1}, "Peak Quality", juce::NormalisableRange<float>(0.1f, 10.f, 0.05f, 1.f), 0.0f));
        ...
        layout.add(std::make_unique<juce::AudioParameterChoice>(juce::ParameterID{"HighCut Slope", 1}, "HighCut Slope", stringArray, 1));
        ...
        layout.add(std::make_unique<juce::AudioParameterBool>(juce::ParameterID{"Analyzer Enabled", 1}, "Analyzer Enebled", true));
